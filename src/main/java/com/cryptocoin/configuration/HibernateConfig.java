...
@ComponentScan("com.cryptocoin")
@Configuration
@EnableTransactionManagement
public class HibernateConfig {

	private final static String DATABSE_URL = "jdbc:mysql://root.cosxwztagphg.us-east-2.rds.amazonaws.com:3306/cryptocoin";
	private final static String DATABSE_DRIVER = "com.mysql.jdbc.Driver";
	private final static String DATABSE_USERNAME = "root";
	private final static String DATABSE_PASSWORD = "rootroot";
	...
	public SessionFactory sessionFactory(DataSource dataSource) {
		...
		builder.scanPackages("com.cryptocoin.beans");
